...
//  * 
//  * This class contains many commonly used methods for telegram, the user has the ability to modify this file
//  * 
//  * @method static sendMessage()         makes a static connection to the telegram api and sends messages in text form
//  * @method static forwardMessage()      performs a static connection for the telegram api and sends forward messages of any appearance
//  * @method static copyMessage()         makes a static connection to the telegram api and sends messages of any appearance by copying
//  * @method static sendPhoto()           makes a static connection to the telegram api and sends messages with an image type
//  * @method static sendAudio()           performs a static connection for the telegram api and sends messages of audio type
//  * @method static sendDocument()        makes a static connection to the telegram api and sends the documents from the telegram's internal memory
//  * 
//  *  
//  */
